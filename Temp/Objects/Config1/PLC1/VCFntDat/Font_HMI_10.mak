...
$(AS_CPU_PATH)/VcFntDat/arialbd.vco:$(AS_CPU_PATH)/VcFntDat/arialbd.vci
	 $(VCC) -f '$<' -o '$@' $(TTFFLAGS_HMI_10) $(VCCFLAGS_HMI_10)

$(AS_CPU_PATH)/VcFntDat/arialbd.ccf:$(AS_CPU_PATH)/VcFntDat/arialbd.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbd.ttf -name HMI_10 -profile 'False' -sfas

$(AS_CPU_PATH)/arialbd.br:$(AS_CPU_PATH)/VcFntDat/arialbd.ccf
	 $(MODGEN) -m $(VCLOD) -f '$<' -o '$@' -d vcgclass -v V1.00.0 -profile False -vc '$(VCOBJECT_HMI_10)' -b
endif
...
$(AS_CPU_PATH)/VcFntDat/arialbi.ccf:$(AS_CPU_PATH)/VcFntDat/arialbi.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbi.ttf -name HMI_10 -profile 'False' -sfas
...
$(AS_CPU_PATH)/VcFntDat/arial.ccf:$(AS_CPU_PATH)/VcFntDat/arial.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arial.ttf -name HMI_10 -profile 'False' -sfas

$(AS_CPU_PATH)/arial.br:$(AS_CPU_PATH)/VcFntDat/arial.ccf
	 $(MODGEN) -m $(VCLOD) -f '$<' -o '$@' -d vcgclass -v V1.00.0 -profile False -vc '$(VCOBJECT_HMI_10)' -b
endif

FONT_MODULES_HMI_10=$(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/arialbd.br $(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/arialbi.br $(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/arial.br 
