...
ACP10GLIPA_typ : STRUCT                                     (* INIT Parameters *)
   ...
   error                : USINT ;                           (* Error *)
   reserve              : UINT ;                            (* Reserved *)
   datobj_ident         : UDINT ;                           (* Data object ident of the data module *)
...
ACP10MTXPA_typ : STRUCT                                     (* Parameters for text determination *)
   format               : UINT ;                            (* Format of the error record *)
...
ACP10MTR_typ : STRUCT                                       (* Trace *)
   ...
   test_dat             : ARRAY [0..29] OF ACP10MTRDA_typ ;  (* Test data *)
...
ACP10DBLST_typ : STRUCT                                     (* Status *)
   data_len             : UDINT ;                           (* Length of data block which was  transferred to the drive *)
...
ACP10DBLPA_typ : STRUCT                                     (* Parameters *)
   data_len             : UDINT ;                           (* Length of data block in application program *)
   data_adr             : UDINT ;                           (* Data address *)
   data_modul           : ARRAY [0..11] OF USINT ;          (* Name of the data module *)
   index                : UINT ;                            (* Index *)
   mode                 : UINT ;                            (* Mode *)
...
ACP10DAMST_typ : STRUCT                                     (* Status *)
   datobj_ident         : UDINT ;                           (* Data object ident of the data module *)
   ok                   : USINT ;                           (* Global initialization complete *)
   error                : USINT ;                           (* Error *)
   reserve1             : USINT ;                           (* Reserved *)
   reserve2             : USINT ;                           (* Reserved *)
...
ACP10SMCCFGOUTDA_typ : STRUCT                               (* SafeMC configuration: SafeOUT data *)
   ctrl                 : ARRAY [0..2] OF USINT ;           (* Control bytes *)
   reserve1             : USINT ;                           (* Reserved *)
END_STRUCT;
...
ACP10SMCCFGINDA_typ : STRUCT                                (* SafeMC configuration: SafeIN data *)
   status               : ARRAY [0..2] OF USINT ;           (* Status bytes *)
   v                    : ARRAY [0..1] OF USINT ;           (* Velocity *)
   reserve1             : ARRAY [0..3] OF USINT ;           (* Reserved *)
   reserve2             : USINT ;                           (* Reserved *)
END_STRUCT;
...
ACP10SAFEINDAT_typ : STRUCT                                 (* SafeMC: SafeIN data *)
   ...
   reserved_stat_b14    : USINT ;                           (* reserved_stat_b14 *)
   reserved_stat_b15    : USINT ;                           (* reserved_stat_b15 *)
   reserved_stat_b16    : USINT ;                           (* reserved_stat_b16 *)
...
ACP10SAFEOUTDAT_typ : STRUCT                                (* SafeMC: SafeOUT data *)
   ...
   reserved_ctrl_b14    : USINT ;                           (* reserved_ctrl_b14 *)
   reserved_ctrl_b15    : USINT ;                           (* reserved_ctrl_b15 *)
   reserved_ctrl_b16    : USINT ;                           (* reserved_ctrl_b16 *)
   reserved_ctrl_b17    : USINT ;                           (* reserved_ctrl_b17 *)
   reserved_ctrl_b18    : USINT ;                           (* reserved_ctrl_b18 *)
