...
FUNCTION_BLOCK MC_BR_AutoCamDwell (*starts a link between master and slave with a self calculated cam profile*)
	VAR_INPUT
		Master : UDINT; (*axis reference of master axis*)
	...
	END_VAR
	VAR_OUTPUT
		Active : BOOL; (*parameters are transfered and FB is active*)
		Busy : BOOL; (*function block is enabled*)
		CommandAborted : BOOL; (*function block aborted by another FB*)
		Error : BOOL; (*error occurred in FB*)
		ErrorID : UINT; (*error number*)
		DataInitialized : BOOL; (*parameters are transfered*)
...
FUNCTION_BLOCK MC_BR_CamTransition (*starts a cam profile link between the master and the slave axis*)
	...
	VAR
		...
		AutStatusValid : BOOL; (*internal variable*)
		Reserve1 : BOOL; (*internal variable*)
		AutActualStateIndexOffset : UINT; (*internal variable*)
		AutActualStateIndexRecIndex : USINT; (*internal variable*)
...
FUNCTION_BLOCK MC_BR_CyclicReadDataInfo (*Read administrative information of cyclic read data*)
	...
	VAR_OUTPUT
		...
		RecordCount : UINT;
		ParIDCount : UINT;
		RecordUpdateTime : DINT;
		TotalUpdateTime : DINT;
		RecordIndex : UINT;
		RecordInfo : MC_RECORD_INFO_REF;
	END_VAR
	VAR
		C_Axis : UDINT; (*internal variable*)
...
FUNCTION_BLOCK MC_BR_InitParSequ (*initializes a parameter sequence*)
	...
	VAR
		C_Axis : UDINT; (*internal variable*)
		C_DataAddress : UDINT; (*internal variable*)
		size : UINT; (*internal variable*)
		startTicks : UDINT; (*internal variable*)
		C_Error : BOOL; (*internal variable*)
		C_ErrorID : UINT; (*internal variable*)
		timeOut : UDINT; (*internal variable*)
		index : USINT; (*internal variable*)
		errorCount : UINT; (*internal variable*)
		state : USINT; (*internal variable*)
		LockIDPar : USINT; (*internal variable*)
	END_VAR
END_FUNCTION_BLOCK
...
FUNCTION_BLOCK MC_BR_MoveCyclicPosition (*commands the axis to follow a cyclically transfered position*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*as long as Enable is TRUE the cyclic position is transfered to the axis*)
		CyclicPosition : MC_CYCLIC_POSITION; (*cyclic position that is transfered to the axis*)
	...
	END_VAR
	VAR_OUTPUT
		Valid : BOOL; (*position is beeing transfered to the axis*)
		Busy : BOOL; (*function block is not finished*)
		CommandAborted : BOOL; (*function block is aborted by another command*)
		Error : BOOL; (*error occurred in FB*)
		ErrorID : UINT; (*error number*)
...
FUNCTION_BLOCK MC_BR_MoveCyclicVelocity (*commands the axis to move with a cyclically transfered velocity*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*as long as Enable is TRUE the cyclic velocity is transfered to the axis*)
		CyclicVelocity : REAL; (*cyclic velocity that is transfered to the axis*)
		Direction : USINT; (*direction of movement*)
	...
	END_VAR
	VAR_OUTPUT
		Valid : BOOL; (*velocity is beeing transfered to the axis*)
		Busy : BOOL; (*function block is not finished*)
		CommandAborted : BOOL; (*function block is aborted by another command*)
		Error : BOOL; (*error occurred in function block*)
		ErrorID : UINT; (*error number*)
...
FUNCTION_BLOCK MC_BR_NetTrace (*controls the network command trace*)
	...
	VAR_OUTPUT
		...
		Busy : BOOL; (*function block is not finished*)
		Error : BOOL; (*error occurredin FB*)
		ErrorID : UINT; (*error number*)
...
FUNCTION_BLOCK MC_BR_ReadCyclicPosition (*read the position of an axis cyclically*)
	...
	END_VAR
	VAR_OUTPUT
		Valid : BOOL; (*posiiton is beeing read from the axis*)
		Busy : BOOL; (*function block is not finished*)
		Error : BOOL; (*error occurred in FB*)
		ErrorID : UINT; (*error number*)
...
FUNCTION_BLOCK MC_BR_SetupIsqRipple (*starts the setup for isq ripple compensation  and saves the parameters*)
	VAR_INPUT
		...
		Execute : BOOL;
		Command : UINT;
		Configuration : MC_SETUP_ISQ_RIPPLE_CFG_REF;
	END_VAR
	VAR_OUTPUT
		Done  : BOOL;
		Busy : BOOL;
		...
		Error : BOOL;
		ErrorID : UINT;
		SetupOutput : MC_SETUP_OUTPUT_REF;
	END_VAR
	VAR
		C_Axis : UDINT;
		IS : MC_0101_IS_TYP;
...
FUNCTION_BLOCK MC_BR_SetupMotorPhasing (*starts a phasing setup and saves the parameters*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*starts the comamnded action at rising edge*)
		Command : UINT; (*choose the command for the setup*)
...
FUNCTION_BLOCK MC_BR_VelocityControl (*sends cyclic speed set value for torque control*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
...
FUNCTION_BLOCK MC_GearInPos (*commands a gear ratio between the position of the slave and master axis*)
	...
	VAR
		...
		C_RatioNumerator : DINT; (*internal variable*)
		C_RatioDenominator : DINT; (*internal variable*)
		CC_RatioNumerator : DINT; (*internal variable*)
		CC_RatioDenominator : DINT; (*internal variable*)
...
FUNCTION_BLOCK MC_001_ReadActualVelocity (*returns the axis velocity*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*read the velocity continuously while enabled*)
	END_VAR
...
FUNCTION_BLOCK MC_002_ReadActualTorque (*returns the axis torque*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*read the actual torque continuously while enabled*)
	END_VAR
...
FUNCTION_BLOCK MC_003_GearInPos (*commands a gear ratio between the position of the slave and master axis*)
	VAR_INPUT
		Master : UDINT; (*axis reference of the master axis*)
		Slave : UDINT; (*axis reference of the slave axis*)
		Execute : BOOL; (*start the gearing process at the rising edge*)
	...
	VAR
		...
		C_Error : BOOL; (*internal variable*)
		C_ErrorID : UINT; (*internal variable*)
		CC_RatioNumerator : INT; (*internal variable*)
		CC_RatioDenominator : UINT; (*internal variable*)
		CC_Error : BOOL; (*internal variable*)
		C_Velocity : REAL; (*internal variable*)
		MaPosition : DINT; (*internal variable*)
		DataTyp : UINT; (*internal variable*)
...
FUNCTION_BLOCK MC_004BR_BrakeOperation (*opens and closes the holding brake when the controller is off*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*execute brake command at rising edge*)
		BrakeCommand : USINT; (*brake command, open or close*)
...
FUNCTION_BLOCK MC_005BR_MoveAbsoluteTriggSto (*starts a movement to specified Position, at trigger event it moves the TriggerDistance*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*start move at rising edge*)
		TriggerInput : MC_TRIGGER_REF; (*trigger input signal source*)
		Position : REAL; (*target position for the motion*)
		Velocity : REAL; (*maximum velocity*)
		Acceleration : REAL; (*maximum acceleration*)
...
FUNCTION_BLOCK MC_006BR_MoveAdditiveTriggSto (*starts a movement for the specified distance, at trigger event it moves the TriggerDistance*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*start move at rising edge*)
		TriggerInput : MC_TRIGGER_REF; (*trigger input signal source*)
...
FUNCTION_BLOCK MC_007BR_MoveVelocityTriggSto (*starts a movement with specified velocity in specified direction, a trigger stops the axis*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*start move at rising edge*)
		TriggerInput : MC_TRIGGER_REF; (*trigger input signal source*)
...
FUNCTION_BLOCK MC_008BR_ReadParID (*reads a ParID from the specified axis*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*read data at rising edge*)
		ParID : UINT; (*number of the parameter ID to read*)
	...
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*Value of ParID has been copied to user variable*)
		Busy : BOOL; (*function block is not finished*)
		Error : BOOL; (*error occurred in function block*)
		ErrorID : UINT; (*error number*)
	END_VAR
...
FUNCTION_BLOCK MC_009BR_WriteParID (*writes a ParID to specified axis*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*write data at rising edge*)
		ParID : UINT; (*number of the parameter ID to write*)
	...
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*value of the user variable has been copied to ParID*)
		Busy : BOOL; (*parameter write is in progress*)
		Error : BOOL; (*error occurred in FB*)
		ErrorID : UINT; (*error number*)
	END_VAR
...
FUNCTION_BLOCK MC_010BR_InitCyclicRead (*adds the specified ParID to the cyclic data from drive*)
	VAR_INPUT
		Axis : UDINT; (*axis refrence*)
		Execute : BOOL; (*initialize cyclic data read at rising edge*)
		ParID : UINT; (*number of the parameter ID to read cyclically*)
...
FUNCTION_BLOCK MC_011BR_InitCyclicWrite (*adds the specified ParID to the cyclic data to the drive*)
	VAR_INPUT
		Axis : UDINT; (*axis rference*)
		Execute : BOOL; (*initialize cyclic data write at rising edge*)
		ParID : UINT; (*number of the Parameter ID to write cyclically*)
		DataAddress : UDINT; (*address of the user variable*)
		DataType : UINT; (*data type of the user variable*)
		Mode : UINT; (*mode for later usage*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*initialization of the data write command is done*)
		Busy : BOOL; (*function block is not finished*)
...
FUNCTION_BLOCK MC_012BR_InitParList (*initializes a parameter list*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initialize parameter list at rising edge*)
		DataAddress : UDINT; (*address of the parameter list*)
...
FUNCTION_BLOCK MC_013BR_InitParTabObj (*transfers and initializes the parameters contained in "DataObjName" on the specified axis*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initialize parameter table at rising edge*)
		DataObjectName : STRING[12]; (*name of the data object*)
...
FUNCTION_BLOCK MC_014BR_DownloadCamProfileOb (*transfers a cam profile object to the drive*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*download camprofile at rising edge*)
		DataObjectName : STRING[12]; (*name of the data object*)
	...
	VAR
		...
		LockIDPar : USINT; (*internal variable*)
		C_Index : UINT; (*internal variable*)
		C_Error : BOOL; (*inrternal variable*)
		C_ErrorID : UINT; (*internal variable*)
		C_Periodic : BOOL; (*internal variable*)
		C_Done : BOOL; (*internal variable*)
		state : USINT; (*internal variable*)
...
FUNCTION_BLOCK MC_015BR_DownloadParSequ (*downloads a parameter sequence*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*download parameter sequence at rising edge*)
		DataAddress : UDINT; (*data address of the parameter sequence *)
...
FUNCTION_BLOCK MC_016BR_InitParSequ (*initializes the parameter sequence*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initialize parameter sequence at rising edge*)
		DataAddress : UDINT; (*address of teh parameter sequence*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*init completed*)
		Busy : BOOL; (*function block is not finished*)
...
FUNCTION_BLOCK MC_017BR_InitAutPar (*initializes the general parameters of the cam automat*)
	VAR_INPUT
		Master : UDINT; (*axis reference of the master axis*)
		Slave : UDINT; (*axis reference of the slave axis*)
		Execute : BOOL; (*initialize parameter at rising edge*)
...
FUNCTION_BLOCK MC_018BR_InitAutState (*initializes the parameters of a cam automat state*)
	VAR_INPUT
		Master : UDINT; (*axis reference of the master axis*)
		Slave : UDINT; (*axis reference of the slave axis*)
		Execute : BOOL; (*initialize parameter at rising edge*)
...
FUNCTION_BLOCK MC_019BR_InitAutEvent (*initializes the parameters of an event for te specified cam automat state*)
	VAR_INPUT
		Slave : UDINT; (*axis reference of the slave axis*)
		Execute : BOOL; (*initialize parameter at rising edge*)
		StateIndex : USINT; (*state index for this event*)
...
FUNCTION_BLOCK MC_020BR_AutControl (*controls the cam automat functions*)
	VAR_INPUT
		Enable : BOOL; (*enables the functionality of this FB*)
		Slave : UDINT; (*axis reference of the slave axis*)
		ParLock : USINT; (*lock for consistent online change*)
...
FUNCTION_BLOCK MC_021_ReadDigitalInput (*reads an digital input on an ACOPOS plug-in module*)
	VAR_INPUT
		Input : MC_INPUT_REF; (*reference to input signal source*)
		Enable : BOOL; (*get value of selected input signal continuously while enabled*)
	END_VAR
...
FUNCTION_BLOCK MC_022_ReadDigitalOutput (*reads a digital output*)
	VAR_INPUT
		Output : MC_OUTPUT_REF; (*reference to signal outputs*)
		Enable : BOOL; (*get value of selected output signal continouosly while enabled*)
	END_VAR
...
FUNCTION_BLOCK MC_023_WriteDigitalOutput (*writes a digital output*)
	VAR_INPUT
		Output : MC_OUTPUT_REF; (*reference to signal output*)
		Execute : BOOL; (*write the value of selected output*)
		Value : BOOL; (*the value of the selected output*)
...
FUNCTION_BLOCK MC_024BR_InitMasterParIDTrans (*initializes a cyclic ParID transfer from master to slave*)
	VAR_INPUT
		Master : UDINT; (*axis reference of the master axis*)
		Slave : UDINT; (*axis reference of the slave axis*)
		Execute : BOOL; (*initialize transfer at rising edge*)
...
FUNCTION_BLOCK MC_025BR_InitModPos (*initializes the modulo position parameters*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initialize the modulo position parameter at rising edge*)
		Period : UDINT; (*axis period*)
		Factor : UDINT; (*factor for conversion into init parameter module units*)
	END_VAR
	VAR_OUTPUT
...
FUNCTION_BLOCK MC_026BR_DownloadCamProfileDa (*transfers cam profile data to the drive*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*download cam profile at rising edge*)
		DataAddress : UDINT; (*address of cam profile data*)
...
FUNCTION_BLOCK MC_027BR_InitAxisPar (*initializes the axis parameter in the axis data structure*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initializes the axis parameter at rising edge*)
	END_VAR
...
FUNCTION_BLOCK MC_028BR_SaveAxisPar (*writes the axis parameters in the axis data structure*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*write axis parameter from axis structure to init parameter module at rising edge*)
		DataObjectName : STRING[12]; (*name of the init parameter module*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*saving the data is finished*)
...
FUNCTION_BLOCK MC_029BR_LoadAxisPar (*loads axis parameter from specified init parameter module to axis data structure*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*loads the init parameter module at rising edge*)
		DataObjectName : STRING[12]; (*name of the init parameter module*)
...
FUNCTION_BLOCK MC_030BR_InitAxisSubjectPar (*enables the user to selectively initialize structure element from the axis data structure*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initializes the axis parameters in the selected axis structure*)
		Subject : UINT; (*subject of the axis structure whose data should be initialized*)
...
FUNCTION_BLOCK MC_031BR_TouchProbe (*saves the values of ParIDs when a specified event occurs*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		TriggerInput : MC_BR_TRIGGER_REF; (*input that is used as event source*)
		Enable : BOOL; (*as long as enable is TRUE, a value is saved every time a trigger event occurs*)
		Period : REAL; (*interval between two expected trigger positions*)
		PeriodChange : REAL; (*if no valid event occurs within an interval, the window is shifted by the value of Period*)
		ExpectedValue : REAL; (*expexted position of the trigger event within the Period*)
		WindowNegative : REAL; (*range before the expected position in which the trigger signal may occurs*)
		WindowPositive : REAL; (*range after the expected position in which the trigger signal may occur*)
		Mode : UINT; (*the way the FB works can be determined with this input*)
	END_VAR
	VAR_OUTPUT
		Active : BOOL; (*waits for a trigger event*)
		Busy : BOOL; (*function block is not ready*)
		Error : BOOL; (*error occured in FB*)
		ErrorID : UINT; (*error number*)
		RecordedPeriodicValue : REAL; (*result value within the configured period*)
		RecordedValue : DINT; (*result value*)
...
FUNCTION_BLOCK MC_032BR_Offset (*adds an offset to the position of slave axis*)
	VAR_INPUT
		Slave : UDINT; (*axis reference of the slave axis*)
		Enable : BOOL; (*enable the function block*)
		InitData : BOOL; (*initialize the input data*)
		PerformVelocityControl : BOOL; (*enable the phase shift*)
		Shift : REAL; (*offset shift value*)
		Velocity : REAL; (*velocity for reaching offset shift*)
		Acceleration : REAL; (*acceleration for reaching offset shift*)
		ApplicationDistance : REAL; (*distance within which the offset shift occurs*)
		ApplicationMode : UINT; (*basis of movement profile*)
		ShiftMode : UINT; (*definition of how the value on the "Shift" input should be used*)
		AdvancedParameters : MC_ADVANCEDSHIFTPAR_REF; (*structure for using additional functions*)
...
FUNCTION_BLOCK MC_033BR_Phasing (*causes a phase shift in the master position of the slave axis*)
	VAR_INPUT
		Slave : UDINT; (*axis reference of the slave axis*)
		Enable : BOOL; (*enable the function block*)
		InitData : BOOL; (*initialize the input data*)
		PerformVelocityControl : BOOL; (*enable the phase shift*)
		Shift : REAL; (*phase shift value*)
		Velocity : REAL; (*velocity for reaching phase shift*)
		Acceleration : REAL; (*acceleration for reaching phase shift*)
		ApplicationDistance : REAL; (*distance within which the phase shift occurs*)
		ApplicationMode : UINT; (*basis for movement profile*)
		ShiftMode : UINT; (*definition of how the value on the "Shift" input should be used*)
		AdvancedParameters : MC_ADVANCEDSHIFTPAR_REF; (*structure for using additional functions*)
	...
	VAR
		C_Slave : UDINT; (*internal variable*)
		C_InitiData : BOOL; (*internal variable*)
		C_PerformVelocityControl : BOOL; (*internal variable*)
		C_Shift : DINT; (*internal variable*)
		C_Velocity : REAL; (*internal variable*)
		C_Acceleration : REAL; (*internal variable*)
...
FUNCTION_BLOCK MC_034BR_EventMoveAbsolute (*starts an absolute positioning movement after a specified event*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*wait for a event at rising edge*)
		EventInput : MC_BR_EVINPUT_REF; (*input that is used as event source*)
		Position : REAL; (*target position for the movement*)
		Velocity : REAL; (*maximum velocity*)
		Acceleration : REAL; (*maximum acceleration*)
...
FUNCTION_BLOCK MC_035BR_EventMoveAdditive (*starts a movement on the drive by a set dictance after a specified event*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*wait for the event at rising edge*)
		EventInput : MC_BR_EVINPUT_REF; (*input that is used as event source*)
...
FUNCTION_BLOCK MC_036BR_EventMoveVelocity (*starts a controlled movement with a specified velocity after a specified event*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*wait for the event at rising edge*)
		EventInput : MC_BR_EVINPUT_REF; (*input that is used as event source*)
...
FUNCTION_BLOCK MC_037BR_CamDwell (*starts a cam profile link between the master and the slave axis*)
	VAR_INPUT
		Master : UDINT; (*axis reference of the master axis*)
		Slave : UDINT; (*axis reference of the slave axis*)
		Enable : BOOL; (*function block is activated*)
		InitData : BOOL; (*starts transferring the parameters*)
		LeadInMasterDistance : REAL; (*master axis compenstaion distance for the lead in*)
		LeadInSlaveDistance : REAL; (*slave axis compensation distance for the lead in*)
		LeadInMasterOffset : REAL; (*master side offset within the cam profile*)
		LeadOutMasterDistance : REAL; (*master axis compensation distance for the lead out*)
		LeadOutSlaveDistance : REAL; (*slave axis compensation distance for the lead out*)
		LeadOutMasterOffset : REAL; (*master side offset within the cam profile*)
		MasterStartPosition : REAL; (*master position where the am profile starts*)
		MasterDwellDistance : REAL; (*master length of the optional dwell section*)
		MasterScaling : REAL; (*factor of the master profile*)
		SlaveScaling : REAL; (*factor of the slave scaling*)
		CamTableID : USINT; (*ID number of the cam profile*)
...
FUNCTION_BLOCK MC_038BR_AutoCamDwell (*starts a link between master and slave with a self calculated cam profile*)
	VAR_INPUT
		Master : UDINT; (*axis reference of master axis*)
		Slave : UDINT; (*axis reference of slave axis*)
		Enable : BOOL; (*function block is activated*)
...
FUNCTION_BLOCK MC_039BR_HomeAcpEncoder (*makes possible to home an external encoder*)
	VAR_INPUT
		AcpEncoder : MC_ACP_ENCOD_REF; (*ACOPOS encoder*)
		Execute : BOOL; (*starts homing the encoder*)
		HomingParameters : MC_ACP_ENCOD_PARAM_REF; (*parameter for homing the encoder*)
...
FUNCTION_BLOCK MC_040BR_CyclicRead (*enters the specified ParID in the cyclic data from drive and returns it*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*specified ParID is read from the drive as long as enable is TRUE*)
		ParID : UINT; (*ParID which should be read from the drive*)
...
FUNCTION_BLOCK MC_041BR_CyclicWrite (*enters a specified ParID in the cyclic data to drive*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*specified ParID is written to the drive as long as enable is TRUE*)
		ParID : UINT; (*ParID which should be written to the drive*)
...
FUNCTION_BLOCK MC_042BR_Simulation (*turns on or off simulation mode for a drive*)
	VAR_INPUT
		Axis : UDINT; (*axis referennce*)
		Execute : BOOL; (*switch simulation mode on or off at increasing edge*)
		SimulationCommand : UINT; (*choose if switch on or off simulation mode*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*simulation mode is on or off*)
...
FUNCTION_BLOCK MC_043BR_ReadDriveStatus (*checks the status of a drive*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*when set the status is read*)
		AdrDriveStatus : UDINT; (*address of the structur where the status is written on*)
...
FUNCTION_BLOCK MC_044BR_CalcCamFromSections (*calculates from a list of points a cam profile*)
	VAR_INPUT
		Execute : BOOL; (*calculation starts at rising edge*)
		DataAddress : UDINT; (*data address of the input data with the list of points*)
		CamProfileAddress : UDINT; (*data address for the calculated cam profile*)
...
FUNCTION_BLOCK MC_046BR_ReadAutPosition (*reads the cam profile automat position*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*automat position is read at rising edge*)
	END_VAR
...
FUNCTION_BLOCK MC_047BR_InitAutData (*initialize the parameters of cam profile automat*)
	VAR_INPUT
		Slave : UDINT; (*slave axis*)
		Execute : BOOL; (*starts initialization at rising edge*)
		InitOptions : MC_AUTINITOPTIONS_REF; (*configuration of the FB*)
		AdrAutData : UDINT; (*address of the automat data structure*)
		Force : BOOL; (*the transfer of all parameters can be forced*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*initialization complete*)
		Busy : BOOL; (*initialization active*)
...
FUNCTION_BLOCK MC_048BR_GetErrorText (*determines the error text for an error record*)
	VAR_INPUT
		Execute : BOOL; (*error text determined after a rising edge*)
		Configuration : MC_ERRORTEXTCONFIG_REF; (*FB configuration*)
		ErrorRecord : MC_ERRORRECORD_REF; (*error record for which the error text should be determined*)
...
FUNCTION_BLOCK MC_049BR_NetTrace (*controls the network command trace*)
	VAR_INPUT
		Execute : BOOL; (*save data at rising edge*)
		Command : UINT; (*select the command for the network command trace*)
		Configuration : MC_NETTRACECONFIG_REF; (*FB configuration*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*save complete*)
		Busy : BOOL; (*function block is not finished*)
		Error : BOOL; (*error occurredin FB*)
		ErrorID : UINT; (*error number*)
		ErrorRecord : MC_ERRORRECORD_REF; (*error messages that can occur after executing the command*)
...
FUNCTION_BLOCK MC_050BR_ReadNetTraceStatus (*determines the current status of the network command trace*)
	VAR_INPUT
		Enable : BOOL; (*the status of the network command trace is read as long as the input is enabled*)
		Configuration : MC_NETTRACECONFIG_REF; (*FB configuration. Only the element "NetTrace" is evaluated*)
	END_VAR
...
FUNCTION_BLOCK MC_051BR_ParTrace (*controls the parameter trace*)
	VAR_INPUT
		Execute : BOOL; (*execute command at rising edge*)
		Command : UINT; (*select the command for the trace*)
		Configuration : MC_PARTRACECONFIG_REF; (*FB configuration*)
	...
	END_VAR
	VAR
		IS : MC_0080_IS_TYP; (*internal variable*)
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK MC_052BR_ReadParTraceStatus (*determines the current status of the axis trace*)
	VAR_INPUT
		Enable : BOOL; (*the status of the axis trace is read as long as the input is enabled*)
		Configuration : MC_PARTRACECONFIG_REF; (*FB configuration. Only the element "ParTrace" is evaluated*)
	END_VAR
...
FUNCTION_BLOCK MC_053BR_InitEndlessPosition (*initialize memory for endless position storage*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*initialize memory storage at rising edge*)
		DataAddress : UDINT; (*data address of momory storage for endless position*)
...
FUNCTION_BLOCK MC_056BR_GetCamSlavePosition (*get the slave position according to cam profile and master position*)
	VAR_INPUT
		Master : UDINT; (*master axis reference*)
		Slave : UDINT; (*slave axis reference*)
		Execute : BOOL; (*start slave position determination*)
...
FUNCTION_BLOCK MC_057BR_GetCamMasterPosition (*get the master position according to cam profile and slave position*)
	VAR_INPUT
		Master : UDINT; (*master axis reference*)
		Slave : UDINT; (*slave axis reference*)
		Execute : BOOL; (*start master position determination*)
...
FUNCTION_BLOCK MC_058BR_SetupInductionMotor (*starts the motorsetup for an induction motor and saves the parameters*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*starts the commanded action at rising edge*)
		Command : UINT; (*choose the command for the setup*)
...
FUNCTION_BLOCK MC_059BR_SetupController (*starts a controller setup and saves the parameters*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*starts the command action at rising edge*)
		Command : UINT; (*choose the command for the setup*)
...
FUNCTION_BLOCK MC_060BR_PowerMeter (*executes the evaluation of the powerdata of a LVM*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Enable : BOOL; (*as long as Enable is TRUE the power evaluation is active*)
		Mode : USINT; (*choose the mode for the power evaluation*)
...
FUNCTION_BLOCK MC_061BR_ReadParIDText (*reads a ParID from the specified axis in text format*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*read data at rising edge*)
		ParID : UINT; (*number of the parameter ID to read*)
...
FUNCTION_BLOCK MC_062BR_WriteParIDText (*writes a ParID from the specified axis in text format*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*write data at rising edge*)
		ParID : UINT; (*number of the parameter ID to write*)
...
FUNCTION_BLOCK MC_064BR_SetupMotorPhasing (*starts a phasing setup and saves the parameters*)
	VAR_INPUT
		Axis : UDINT; (*axis reference*)
		Execute : BOOL; (*starts the comamnded action at rising edge*)
		Command : UINT; (*choose the command for the setup*)
...
FUNCTION_BLOCK MC_065BR_CyclicReadDataInfo (*Read administrative information of cyclic read data*)
	VAR_INPUT
		Axis : UDINT;
		Enable : BOOL;
	END_VAR
...
FUNCTION_BLOCK MC_066BR_AutCommand (*transferes commands for the cam automat to the drive*)
	VAR_INPUT
		Slave : UDINT; (*axis reference of the slave axis*)
		Enable : BOOL; (*activates the function block*)
		Start : BOOL; (*starts the cam automat*)
...
FUNCTION_BLOCK MC_068BR_SetupIsqRipple (*starts the setup for isq ripple compensation  and saves the parameters*)
	VAR_INPUT
		Axis : UDINT;
		Execute : BOOL;
		Command : UINT;
...
FUNCTION_BLOCK MC_069BR_ParTraceConfig (*load and save axis trace configuration*)
	VAR_INPUT
		Execute : BOOL; (*execute command at rising edge*)
		Command : UINT; (*select the command for the trace*)
	    AdrTraceConfig : UDINT; (*adress of axis trace configuration*)
