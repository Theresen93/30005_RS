...
#ifndef POWERLNK_H_
#define POWERLNK_H_ 0x1102 /* Version V1.10.2 */
...
#define plSTATE_STATION_CONFIG      0x0003    /* The configuration of the Station is known, but there are no copy entries
                                                 that would cause an activation of the station */
