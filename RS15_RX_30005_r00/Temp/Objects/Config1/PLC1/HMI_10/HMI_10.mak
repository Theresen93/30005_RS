...
# include Shared and Font Makefile (only once)
	include $(AS_TEMP_PATH)/objects/$(AS_CONFIGURATION)/$(AS_PLC)/VCFntDat/Font_HMI_10.mak
ifneq ($(VCINC),1)
	VCINC=1
...
# Hardware sources
PANEL_HW_OBJECT_HMI_10=$(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/HMI_10/dis.Hardware.vco
PANEL_HW_SOURCE_HMI_10=$(AS_PROJECT_PATH)/Physical/Config1/Hardware.hc $(AS_PROJECT_PATH)/Physical/Config1/PLC1/ArConfig.rtc $(AS_PROJECT_PATH)/Physical/Config1/PLC1/Visual.vcm
...
$(TEMP_PATH_HMI_10)/page.P1_Main_BagMachine.vco: $(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Pages/P1_Main_BagMachine.page $(VC_LANGUAGES_HMI_10)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_HMI_10)' $(VCCFLAGS_HMI_10) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_HMI_10)/StyleSheets/Color.vcs' -p HMI_10 -so $(VC_STATIC_OPTIONS_HMI_10) -vcr 3734
...
$(TEMP_PATH_HMI_10)/vcs.Gray.vco: $(AS_PROJECT_PATH)/Logical/HMI/HMI_10/StyleSheets/Gray.vcs
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_HMI_10)' $(VCCFLAGS_HMI_10) -P '$(AS_PROJECT_PATH)' -ds $(DEFAULT_STYLE_SHEET_HMI_10) -p HMI_10 -so $(VC_STATIC_OPTIONS_HMI_10) -vcr 3734
...
$(TEMP_PATH_HMI_10)/layer.Header.vco: $(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Layers/Header.layer $(VC_LANGUAGES_HMI_10)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_HMI_10)' $(VCCFLAGS_HMI_10) -ds $(DEFAULT_STYLE_SHEET_HMI_10) -p HMI_10 -so $(VC_STATIC_OPTIONS_HMI_10) -vcr 3734
...
$(TEMP_PATH_HMI_10)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/HMI/HMI_10/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_HMI_10)' $(VCCFLAGS_HMI_10) -prj '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10' -p HMI_10 -so $(VC_STATIC_OPTIONS_HMI_10) -vcr 3734
...
$(TEMP_PATH_HMI_10)/bdr.Bordermanager.vco: $(BDR_SOURCES_HMI_10)
	$(VCC) -f '$<' -o '$@' -pkg '$(SRC_PATH_HMI_10)' $(BDRFLAGS_HMI_10) $(VCCFLAGS_HMI_10) -p HMI_10
#
# Logical fonts
#
$(TEMP_PATH_HMI_10)/lfnt.en.vco: $(TEMP_PATH_HMI_10)/en.lfnt
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_HMI_10) $(VCCFLAGS_HMI_10) -p HMI_10
$(TEMP_PATH_HMI_10)/lfnt.fr-FR.vco: $(TEMP_PATH_HMI_10)/fr-FR.lfnt
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_HMI_10) $(VCCFLAGS_HMI_10) -p HMI_10
...
$(TARGET_FILE_HMI_10): $(PROJECT_MODULES_HMI_10) $(TEMP_PATH_HMI_10)/HMI_10.prj
	$(MODGEN) -m $(VCSTPOST) -v V1.00.0 -f '$(TEMP_PATH_HMI_10)/HMI_10.prj' -o '$@' -vc '$(VCOBJECT_HMI_10)' $(DEPENDENCIES_HMI_10) $(addprefix -d ,$(notdir $(PROJECT_MODULES_HMI_10:.br=)))

$(AS_CPU_PATH)/HMI_1001.br: $(TEMP_PATH_HMI_10)/HMI_1001.ccf
	$(MODGEN) -m $(VCLOD) -v V1.00.0 -b -vc '$(VCOBJECT_HMI_10)' -f '$<' -o '$@' $(DEPENDENCIES_HMI_10)
...
# Main Module
$(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/VCShared/HMI_10.vcm:
$(TEMP_PATH_HMI_10)/HMI_10.prj: $(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/VCShared/HMI_10.vcm
	...
	$(VCREFHANDLER) -X 'B:/Holweg/RX_Systems_RS15_30005/AS_3090/Rev_1/RS15_RX_30005_r1/Temp/Objects/Config1/PLC1/vcxref.build' -o '$(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/' -verbose 'False' -profile 'False' -ds '$(TEMP_PATH_ROOT_HMI_10)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)/VCShared/dpt.DataPointList.vcxref' -warninglevel 2 -sfas
...
DEL_TARGET01_LFL=$(TEMP_PATH_HMI_10)\HMI_1001.ccf.lfl
$(TEMP_PATH_HMI_10)/HMI_1001.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_HMI_10) $(TEMP_PATH_HMI_10)/HMI_1003.ccf $(LIB_LOCAL_RES_HMI_10) $(TEMP_PATH_HMI_10)/HMI_1002.ccf $(DIS_OBJECTS_HMI_10) $(PAGE_OBJECTS_HMI_10) $(VCS_OBJECTS_HMI_10) $(VCVK_OBJECTS_HMI_10) $(VCRT_OBJECTS_HMI_10) $(TPR_OBJECTS_HMI_10) $(TXTGRP_OBJECTS_HMI_10) $(LAYER_OBJECTS_HMI_10) $(VCR_OBJECT_HMI_10) $(TDC_OBJECTS_HMI_10) $(TRD_OBJECTS_HMI_10) $(TRE_OBJECTS_HMI_10) $(PRC_OBJECTS_HMI_10) $(SCR_OBJECTS_HMI_10)
	...
	@$(VCFLGEN) '$@.lfl' '$(LIB_SHARED)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(LIB_BMP_RES_HMI_10)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(LIB_LOCAL_RES_HMI_10)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(DIS_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .page -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(VCS_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .vcvk -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(VCRT_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(TPR_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .txtgrp -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .layer -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(VCR_OBJECT_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .tdc -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .trd -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(TRE_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(PRC_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(SCR_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	$(LINK) '$@.lfl' -o '$@' -p HMI_10 -lib '$(LIB_LOCAL_OBJ_HMI_10)' -P '$(AS_PROJECT_PATH)' -m 'local objects' -profile 'False' -warningLevel2 -sfas
# 01 Module END

# 02 Module

DEL_TARGET02_LFL=$(TEMP_PATH_HMI_10)\HMI_1002.ccf.lfl
$(TEMP_PATH_HMI_10)/HMI_1002.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_HMI_10) $(TEMP_PATH_HMI_10)/HMI_1003.ccf $(BDR_OBJECTS_HMI_10) $(LFNT_OBJECTS_HMI_10) $(CLM_OBJECTS_HMI_10)
	...
	@$(VCFLGEN) '$@.lfl' '$(LIB_SHARED)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(LIB_BMP_RES_HMI_10)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(BDR_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(LFNT_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' '$(CLM_OBJECTS_HMI_10:.vco=.vco,)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	$(LINK) '$@.lfl' -o '$@' -p HMI_10 -lib '$(LIB_LOCAL_RES_HMI_10)' -P '$(AS_PROJECT_PATH)' -m 'local resources' -profile 'False' -warningLevel2 -sfas
# 02 Module END

# 03 Module

DEL_TARGET03_LFL=$(TEMP_PATH_HMI_10)\HMI_1003.ccf.lfl
$(TEMP_PATH_HMI_10)/HMI_1003.ccf: $(LIB_SHARED) $(SHARED_CCF) $(BMGRP_OBJECTS_HMI_10) $(BMINFO_OBJECTS_HMI_10) $(PALFILE_HMI_10)
	...
	@$(VCFLGEN) '$@.lfl' '$(LIB_SHARED)' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .bmgrp -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	@$(VCFLGEN) '$@.lfl' -mask .bminfo -vcp '$(AS_PROJECT_PATH)/Logical/HMI/HMI_10/Package.vcp' -temp '$(TEMP_PATH_HMI_10)' -prj '$(PRJ_PATH_HMI_10)'
	$(LINK) '$@.lfl' -o '$@' -p HMI_10 -lib '$(LIB_BMP_RES_HMI_10)' -P '$(AS_PROJECT_PATH)' -m 'bitmap resources' -profile 'False' -warningLevel2 -sfas
# 03 Module END
